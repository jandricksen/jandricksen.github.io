...
<div class="social_wrapper">
    <ul>
    	...
    	<?php
    		...
    		{
    	?>
    	<li class="vimeo"><a <?php if(!empty($tg_topbar_social_link)) { ?>target="_blank"<?php } ?> title="Vimeo" href="http://vimeo.com/<?php echo esc_attr($pp_vimeo_username); ?>"><i class="fa fa-vimeo-square"></i></a></li>
    	<?php
    		}
    	?>
    	<?php
        ...
        <?php
        	...
        	{
        ?>
        <li class="500px"><a <?php if(!empty($tg_topbar_social_link)) { ?>target="_blank"<?php } ?> title="500px" href="http://500px.com/<?php echo $pp_500px_username; ?>"><i class="fa fa-500px"></i></a></li>
        <?php
        	}
        ?>
    </ul>
